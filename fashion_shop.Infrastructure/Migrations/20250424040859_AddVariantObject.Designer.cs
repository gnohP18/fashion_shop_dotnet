...
namespace fashion_shop.Infrastructure.Migrations
{
    ...
    [Migration("20250424040859_AddVariantObject")]
    partial class AddVariantObject
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("fashion_shop.Core.Entities.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("fashion_shop.Core.Entities.ProductItem", b =>
                {
                    ...
                    b.Property<string>("VariantObjects")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("variant_objects");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("fashion_shop.Core.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("fashion_shop.Core.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("fashion_shop.Core.Entities.Order", b =>
                {
                    b.HasOne("fashion_shop.Core.Entities.User", "User")
                        .WithMany("Orders")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("fashion_shop.Core.Entities.OrderDetail", b =>
                {
                    ...
                    b.HasOne("fashion_shop.Core.Entities.ProductItem", "ProductItem")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_order_details_product_items_product_item_id");
            ...
            modelBuilder.Entity("fashion_shop.Core.Entities.Product", b =>
                {
                    b.HasOne("fashion_shop.Core.Entities.Category", "Category")
                        .WithMany("Products")
